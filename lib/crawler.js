...
class Crawler {
            ...
            this._addJQuery()
              ...
              .then(result => (
                this._options.onSuccess({
                  ...
                  response: _.pick(response, RESPONSE_FIELDS),
                  result,
                  screenshot,
                })
              ))
  ...
  _screenshot() {
    ...
    const promise = _.isFunction(this._options.screenshot)
      ? Promise.resolve(this._options.screenshot(this._options))
      : Promise.resolve(this._options.screenshot);
    return promise
      .then(options => {
