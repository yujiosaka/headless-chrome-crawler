...
class Crawler {
  ...
  async _scrape() {
    ...
    if (this._options.exposeFunction && this._options.exposedFunctionName) {
      await this._page.exposeFunction(this._options.exposedFunctionName, this._options.exposeFunction);
    }
